...
public class MainActivity extends AppCompatActivity {
    ...
    //Method runs the login sequence on button click
    public void btnLogin(View view) {
        EditText tvUsername = (EditText) findViewById(R.id.tvEmail);
        EditText tvPassword = (EditText) findViewById(R.id.tvFullName);
        ...
        //Agent check
        DatabaseReference agentUserRef = rootRef.child("Users").child("agent").child(username);
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists()) {
                    ...
                    //Login
                    agentUserRef.child("password").addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        //Standard check
        DatabaseReference standardUserRef = rootRef.child("Users").child("standard").child(username);
        ...
        ValueEventListener eventListener2 = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists()) {
                    ...
                    //Login
                    standardUserRef.child("password").addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            String value = dataSnapshot.getValue(String.class);
        ...
        standardUserRef.addListenerForSingleValueEvent(eventListener2);
    }
    ...
    //Goes to agent home activity
    public void goToAgentHome() {
        Intent intent = new Intent(this, agent_home.class);
        startActivity(intent);
    }

    //Goes to standard home activity
    public void goToStandardHome() {
